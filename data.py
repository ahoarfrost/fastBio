...
class BioTextList(TextList):
    ...
    @classmethod
    def from_seqfile(cls, filename:PathOrStr, path:PathOrStr='.', extensions:Collection[str]=supported_seqfiletypes, **kwargs)->'TextList':
    ...
    @classmethod
    def from_folder(cls, path:PathOrStr='.', extensions:Collection[str]=supported_seqfiletypes, recurse:bool=True, **kwargs) -> 'TextList':
...
class BioLMDataBunch(TextLMDataBunch):
    ...
    def from_seqfile(cls, path:PathOrStr, filename:PathOrStr, extensions:Collection[str]=supported_seqfiletypes, 
        ...
        src = BioTextList.from_seqfile(filename=filename, path=path, extensions=extensions, processor=processor)
    ...
    def from_folder(cls, path:PathOrStr, extensions:Collection[str]=supported_seqfiletypes, recurse:bool=True, 
        ...
        src = BioTextList.from_folder(path=path, extensions=extensions, recurse=recurse, processor=processor)
        if valid_pct:
            src = src.split_by_rand_pct(valid_pct=valid_pct, seed=seed)
        else:
...
class BioClasDataBunch(TextClasDataBunch):
    ...
    @classmethod
    def from_seqfile(cls, path:PathOrStr, extensions:Collection[str]=supported_seqfiletypes, recurse:bool=True, 
